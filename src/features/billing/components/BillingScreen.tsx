      ...
      <PageBody className="flex flex-col gap-9">
        ...
        {noAccountYet && (
          <p className="font-sans text-sm leading-relaxed text-muted-foreground">
            There is nothing to bill for yet — no memoir has been created
        ...
        {data && (
          <>
            <section className="flex flex-wrap items-start justify-between gap-6 rounded-2xl border border-border bg-card p-6 shadow-lift">
